...
function Bridal() {
  ...
  return (
    <div className='shop-container'>
      ...
      <footer class="bird-footer-section">
        <div class="bird-footer-logo">
          <h3>DK Bridal <br />Collections</h3>
        </div>
        <div class="bird-footer-links">
          <h4>Links</h4>
          <ul>
