...
function Engagement() {
  ...
  const handleEngagementClick = () => {
    navigate("/Engagement"); // Navigate to the Bridal.js page
  };
//   const handleEngagementClick = () => {
//     navigate("/bridal"); // Navigate to the Bridal.js page
//   };
  return (
    <div className='shop-container'>
      <h1 className='ShopUs'>Engagement</h1>
      ...
      <footer class="engagement-footer-section">
        <div class="engagement-footer-logo">
          <h3>DK Bridal <br />Collections</h3>
        </div>
        <div class="engagement-footer-links">
          <h4>Links</h4>
          <ul>
        ...
        <div class="engagement-footer-contact">
          <h4>Contact</h4>
        ...
        <div class="engagement-footer-social">
          <h4>Follow Us On</h4>
          <ul>
