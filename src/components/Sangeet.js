...
function  Sangeet() {
  ...
  return (
    <div className='shop-container'>
      <h1 className='ShopUs'> Sangeet</h1>
      ...
      <footer class="sangeet-footer-section">
        <div class="sangeet-footer-logo">
          <h3>DK Bridal <br />Collections</h3>
        </div>
        <div class="sangeet-footer-links">
          <h4>Links</h4>
          <ul>
        ...
        <div class="sangeet-footer-contact">
          <h4>Contact</h4>
        ...
        <div class="sangeet-footer-social">
          <h4>Follow Us On</h4>
          <ul>
