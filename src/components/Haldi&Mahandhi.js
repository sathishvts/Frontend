...
function HaldiMehandhi() {
  ...
  return (
    <div className='shop-container'>
      <h1 className='ShopUs'>HaldiMehandhi</h1>
      ...
      <footer class="haldi-footer-section">
        <div class="haldi-footer-logo">
          <h3>DK Bridal <br />Collections</h3>
        </div>
        <div class="haldi-footer-links">
          <h4>Links</h4>
          <ul>
        ...
        <div class="haldi-footer-contact">
          <h4>Contact</h4>
