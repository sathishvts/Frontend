...
function Dailywear() {
  ...
  return (
    <div className='shop-container'>
      <h1 className='ShopUs'>Dailywear</h1>
      ...
      <footer class="daily-footer-section">
        <div class="daily-footer-logo">
          <h3>DK Bridal <br />Collections</h3>
        </div>
        <div class="daily-footer-links">
          <h4>Links</h4>
          <ul>
        ...
        <div class="daily-footer-contact">
          <h4>Contact</h4>
